...
impl Minesweeper {
    pub fn new(width: usize, height: usize, mines_count: usize) -> Minesweeper {
        Minesweeper {
            width,
            height,
            ...
            mines: {
                ...
                while mines.len() < mines_count {
                    mines.insert((random::random_range(0, width), random::random_range(0, height)));
                }
    ...
    pub fn iter_neighbors(&self, (x, y): Position) -> impl Iterator<Item = (usize, usize)> {
